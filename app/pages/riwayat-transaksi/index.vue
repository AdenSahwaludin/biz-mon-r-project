      ...
      <div class="flex flex-wrap items-center gap-3 pt-1 border-t border-gray-100">
        ...
        <div class="flex flex-wrap items-center gap-1.5 bg-gray-50 p-1 rounded-lg border border-gray-200 text-xs font-semibold text-gray-600">
          <button
            ...
            :class="filterPeriod === 'month' ? 'bg-white text-primary-600 shadow-2xs font-bold' : 'hover:text-gray-900'"
          >
            Bulan Ini
          </button>
          <button
            ...
            class="px-2.5 py-1.5 rounded-md transition-all"
            :class="filterPeriod === 'all' ? 'bg-white text-primary-600 shadow-2xs font-bold' : 'hover:text-gray-900'"
          >
            Semua Data
          </button>
          <button
            ...
            class="px-2.5 py-1.5 rounded-md transition-all"
            :class="filterPeriod === 'today' ? 'bg-white text-primary-600 shadow-2xs font-bold' : 'hover:text-gray-900'"
          >
            Hari Ini
          </button>
          <button
            ...
            class="px-2.5 py-1.5 rounded-md transition-all"
            :class="filterPeriod === '7days' ? 'bg-white text-primary-600 shadow-2xs font-bold' : 'hover:text-gray-900'"
          >
            7 Hari Terakhir
          </button>
          <button
            @click="filterPeriod = '30days'"
            class="px-2.5 py-1.5 rounded-md transition-all"
            :class="filterPeriod === '30days' ? 'bg-white text-primary-600 shadow-2xs font-bold' : 'hover:text-gray-900'"
          >
            30 Hari
          </button>
          <button
            ...
            class="px-2.5 py-1.5 rounded-md transition-all"
            :class="filterPeriod === 'custom' ? 'bg-white text-primary-600 shadow-2xs font-bold' : 'hover:text-gray-900'"
          >
            Kustom Tanggal
          </button>
        </div>
        ...
        <div v-if="filterPeriod === 'custom'" class="flex items-center gap-2 text-xs w-full sm:w-auto">
          <input v-model="startDate" type="date" class="px-2.5 py-1.5 border border-gray-300 rounded-md text-xs outline-none focus:ring-2 focus:ring-primary-500" />
          <span class="text-gray-400">s/d</span>
          <input v-model="endDate" type="date" class="px-2.5 py-1.5 border border-gray-300 rounded-md text-xs outline-none focus:ring-2 focus:ring-primary-500" />
        </div>
      </div>
    </div>
        ...
        <table class="w-full text-left border-collapse">
          <thead>
            <tr class="border-b border-gray-200 bg-gray-50/70">
              <th @click="toggleSort('createdAt')" class="text-xs font-semibold text-gray-500 uppercase py-3 px-4 cursor-pointer hover:bg-gray-100 hover:text-gray-700 transition-colors group">
              ...
              <th @click="toggleSort('branch')" class="text-xs font-semibold text-gray-500 uppercase py-3 px-4 cursor-pointer hover:bg-gray-100 hover:text-gray-700 transition-colors group">
                <div class="flex items-center gap-1.5">
                  <span>Cabang</span>
              ...
              <th @click="toggleSort('cashier')" class="text-xs font-semibold text-gray-500 uppercase py-3 px-4 cursor-pointer hover:bg-gray-100 hover:text-gray-700 transition-colors group">
                <div class="flex items-center gap-1.5">
                  <span>Kasir</span>
