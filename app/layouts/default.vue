    ...
    >
      ...
      <div class="h-16 flex items-center gap-2.5 px-5 border-b border-gray-200 shrink-0">
        ...
        <div class="flex flex-col justify-center min-w-0">
          ...
          <span class="text-[10px] font-medium text-gray-400 leading-tight">v.1.0.4</span>
        </div>
...
const pageTitle = computed(() => {
  ...
  const titles: Record<string, string> = {
    ...
    'riwayat-transaksi-id': 'Detail Transaksi',
...
const navItems = computed(() => {
  if (auth.isKaryawan) {
    return [
      ...
      { to: '/riwayat-transaksi', label: 'Riwayat', icon: ClipboardList },
  ...
  return [
    ...
    { to: '/produk', label: 'Produk', icon: Package },
    { to: '/produk/kategori', label: 'Kategori', icon: Tag },
    { to: '/riwayat-transaksi', label: 'Riwayat Transaksi', icon: ClipboardList },
